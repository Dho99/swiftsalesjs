...
function Login(props) {
  ...
  return (
    <div className="overflow-hidden max-h-[200vh] h-full bg-slate-300">
      <div className="h-full grid grid-cols-1 content-center m-auto w-full">
        {/* {users} */}
        <div className="bg-slate-500 lg:w-[450px] md:w-[450px] sm:w-[300px] flex m-auto rounded pt-6 pb-10">
          <div className="block w-5/6 m-auto">
            ...
            <div className="grid grid-cols-1 gap-y-3 relative">
              ...
              <Link
                to={"/register"}
                className="btn btn-outline border-slate-300 w-1/2 hover:bg-slate-400 hover:border-none m-auto rounded-full text-white"
              >
                Register Account
              </Link>
            </div>
